...
results_path = 'Classification report/Classification report for model 2.json'
...
# First Conv2D layer and Batch Normalization
model.add(layers.Conv2D(32, (3, 3), activation='relu', padding='same'))
model.add(layers.BatchNormalization())

# Second Conv2D layer and Batch Normalization
...
# Third Conv2D layer and Batch Normalization
model.add(layers.Conv2D(128, (3, 3), activation='relu', padding='same'))
model.add(layers.BatchNormalization())

# Fourth Conv2D layer and Batch Normalization
...
# Fifth Conv2D layer and Batch Normalization
model.add(layers.Conv2D(512, (3, 3), activation='relu', padding='same'))
model.add(layers.BatchNormalization())

# Sixth Conv2D layer and Batch Normalization
model.add(layers.Conv2D(512, (3, 3), activation='relu', padding='same'))
model.add(layers.BatchNormalization())
...
# Dense layer for multiple output classes
...
results_dict = {
    ...
    'number of epochs in training': 25,
}
